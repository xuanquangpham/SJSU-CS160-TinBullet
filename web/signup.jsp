...
if (db.isExist("users", "username", user)) {
	out.println("The username is already existed. Please choose a diffrent one.<br>");
	out.println("The page will redirect in 5 seconds or click <a href='index.jsp'>here</a>");
	...
	String query = "INSERT INTO users(username, firstname, lastname, email, password)" +
		" VALUES('"+ user + "','" + fname + "','" + lname +"','" + email + "','" + pwd + "')";
	db.update(query);
